...
### Main feature
To compute <p align="center">![](CodeCogsEqn.png),</p> you can use `ComputeDivFact(c(K, (N-K), n, (N-n)), c(k, (K-k), (n-k), (N-K-n+k), N))`. This uses a Prime Factorization to simplify computations.
